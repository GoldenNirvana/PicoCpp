...
void AD56X4Class::setChannel(t_byte setMode, t_byte channel,
                             word value)
{
...
void AD56X4Class::setChannel(int SS_pin, t_byte setMode, word values[])
{
  if (setMode == AD56X4_SETMODE_INPUT
      || setMode == AD56X4_SETMODE_INPUT_DAC
      || setMode == AD56X4_SETMODE_INPUT_DAC_ALL)
...
void AD56X4Class::setChannel(int SS_pin, t_byte setMode, word value_D,
...
void AD56X4Class::updateChannel(t_byte channel)
{
  AD56X4.writeMessage(0, AD56X4_COMMAND_UPDATE_DAC_REGISTER, channel, 0);
}

void AD56X4Class::powerUpDown(int SS_pin, t_byte powerMode,
                              t_byte channelMask)
{
...
void AD56X4Class::powerUpDown(int SS_pin, t_byte powerModes[])
{
...
void AD56X4Class::setInputMode(int SS_pin, t_byte channelMask)
{
...
void AD56X4Class::writeMessage(int SS_pin, t_byte command,
